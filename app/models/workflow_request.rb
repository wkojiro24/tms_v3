class WorkflowRequest < ApplicationRecord
  ...
  METADATA_FIELDS = {
    ...
    leave_type: { label: "休暇種別", type: :text },
    leave_start_on: { label: "開始日", type: :date },
    leave_end_on: { label: "終了日", type: :date },
    leave_days: { label: "日数", type: :text },
    leave_reason: { label: "理由", type: :textarea }
  }.freeze
